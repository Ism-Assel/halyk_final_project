...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers(URL_LOGIN, URL_ERROR).permitAll()
                ...
                .antMatchers(HttpMethod.GET, URL_AUTHOR, URL_BOOK, URL_GENRE, URL_ORDER, URL_PUBLISHER, URL_USER).hasAnyRole(ROLE_ADMIN, ROLE_USER)
